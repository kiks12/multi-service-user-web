...
const AboutProvider: React.FC<AboutProviderProps> = ({ user, accessToken }) => {
    ...
    const messageProvider = async () => {
        ...
        if (createdConversation.conversationExists || createdConversation.status === 200) {
    ...
    return (
        ...
        >
                ...
                >
                    ...
                    <div className="split">
                        ...
                        <button
                            className="ghost-button"
                            onClick={() =>
                                router.push(`/provider/page/${user.userId}`)
                            }
                        >
                            View Shop
                        </button>
            ...
            <div>
                <small className="secondary-purple-text">
                    Shop Description
                </small>
