...
const Bookings: NextPage = ({
    ...
    const updateBookingsState = (cancellationRes: { msg: string; status: number; booking: BookingType }) => {
    ...
    return (
        <Layout accessToken={accessToken}>
            ...
            >
                <i>{"Note: Cancellation is only applicable to bookings that are currently 'To be Approved'"}</i>
            </small>
            ...
            {openMessageModal && (
                <Modal>
                    <div className="card" ref={messageModalRef}>
                        <div className="">
                            <h2>Message</h2>
                            <FontAwesomeIcon icon={faClose} onClick={() => setOpenMessageModal(false)} />
                        </div>
                        <p>{message}</p>

                        <button onClick={() => setOpenMessageModal(false)}>Okay</button>
                    </div>
                </Modal>
            )}
